...
implement the multipath features, including the multiple path establishment, path 
management, realiable transmission with multipath acknowledgment, path 
...
management layer, solve the reordering issue for different paths, and implement scheduling and congestion control algorithms that fit in the multipath scenarios.
