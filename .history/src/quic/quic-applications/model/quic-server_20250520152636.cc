...
/**
 * zhiy zeng: QuicServer 类的完整实现，它继承自 NS-3 的 Application 基类，
 * 实现了 QUIC 服务器端的基本行为：监听连接、接收数据包、统计接收数量与丢包率等。
 */
...
/**
 * zhiy zeng: 注册 QuicServer 类型并定义其可配置属性
 */
TypeId
