...
QuicUdpBinding::QuicUdpBinding ()
  : m_budpSocket (0), // IPv4 UDP 套接字指针，用于绑定 QUIC 到 IPv4 UDP, 0指空指针
  m_budpSocket6 (0), // IPv6 UDP 套接字指针，用于绑定 QUIC 到 IPv6 UDP, 0指空指针
  m_quicSocket (nullptr), // 指向当前绑定的 QUIC Socket 对象
