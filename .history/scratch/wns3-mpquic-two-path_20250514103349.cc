...
main (int argc, char *argv[])
{
    ...
    double rate0a = 5.0; // minimum rate
    double rate1a = 10.0; // minimum rate
    double delay0a = 50.0; // minimum delay
    double delay1a = 10.0; // minimum delay
    double rate0b = 5.0; // maximum rate
    double rate1b = 10.0; // maximum rate
    double delay0b = 50.0; // maximum delay
    double delay1b = 10.0; // maximum delay    
