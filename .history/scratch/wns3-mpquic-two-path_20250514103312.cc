...
main (int argc, char *argv[])
{
    ...
    NodeContainer n0n1 = NodeContainer (c.Get (0), c.Get (1)); // n0 and n1
    NodeContainer n1n8 = NodeContainer (c.Get (1), c.Get (8)); // n1 and n8
    NodeContainer n8n2 = NodeContainer (c.Get (8), c.Get (2)); // n8 and n2
